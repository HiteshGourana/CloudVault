...
import { Mail, Lock, ArrowRight, AlertCircle, Cloud } from 'lucide-react';
    ...
    <div className="min-h-screen bg-dark-600 flex flex-col justify-center items-center px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white">Welcome to CloudVault</h2>
          <p className="text-slate-400 mt-2 text-sm">Enterprise S3 Management SaaS Engine</p>
        </div>
